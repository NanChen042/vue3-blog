...
先看效果：
![alt text](</docs-assets/NodeJS/assets/后端文档/image.png>)

注册的账户
![alt text](</docs-assets/NodeJS/assets/后端文档/image-2.png>)

message
![alt text](</docs-assets/NodeJS/assets/后端文档/image-1.png>)
...
![alt text](</docs-assets/NodeJS/assets/后端文档/image-6.png>)
...
```
![alt text](</docs-assets/NodeJS/assets/后端文档/image-5.png>)

![alt text](</docs-assets/NodeJS/assets/后端文档/image-4.png>)



5. **测试登录**: 使用 ApiFox 向 `POST /auth/login` 发送 JSON 数据，获取 Token。

![alt text](</docs-assets/NodeJS/assets/后端文档/image-3.png>)

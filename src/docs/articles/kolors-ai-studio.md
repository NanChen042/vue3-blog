...
<video controls style="width: 100%;">
  <source src="/docs-assets/AI/assets/video.mp4" type="video/mp4">
  您的浏览器不支持 HTML5 视频标签。
</video>

![外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传](</docs-assets/AI/assets/Kolors_AI_Studio.md/20250409165906.png >)
...
设计了一个左右两栏的布局：
![在这里插入图片描述](</docs-assets/AI/assets/Kolors_AI_Studio.md/image.png>)

...
效果：
![](</docs-assets/ThreeJS/img/Three09Img/tutieshi_390x348_5s.webp>)

```js
const geometry = new THREE.SphereGeometry(50, 50, 50); //长方体
```

![](</docs-assets/ThreeJS/img/Three09Img/qiu.webp>)
...
geometry.attributes.uv = new THREE.BufferAttribute(uvs, 2);
```
![](</docs-assets/ThreeJS/img/Three09Img/4.png>)
...
```
效果如下：
![](</docs-assets/ThreeJS/img/Three09Img/5.png>)
#### 原理
...
![](</docs-assets/ThreeJS/img/Three09Img/6.png>)
...
![](</docs-assets/ThreeJS/img/Three09Img/7.png>)
...
效果：
![](</docs-assets/ThreeJS/img/Three09Img/1.png>)
...
![](</docs-assets/ThreeJS/img/Three09Img/3.png>)
...
```
效果：![](</docs-assets/ThreeJS/img/Three09Img/10s.webp>)
...
```
效果：![](</docs-assets/ThreeJS/img/Three09Img/7s.webp>)
...
```js
  ...
  render();
```
![](</docs-assets/ThreeJS/img/Three09Img/UV.webp>)
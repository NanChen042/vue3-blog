...
![](</docs-assets/ThreeJS/img/Three08Img/1.png>)
...
```js
    ...
    mesh.add(axesHelper);
2
00![](</docs-assets/ThreeJS/img/Three08Img/2.png>)
...
```javascript
    ...
    scene.add(mesh);
```
![](</docs-assets/ThreeJS/img/Three08Img/3.png>)
...
![](</docs-assets/ThreeJS/img/Three08Img/1.jpg>)
...
![](</docs-assets/ThreeJS/img/Three08Img/tutieshi_640x449_6s.webp>)
...
```
![](</docs-assets/ThreeJS/img/Three08Img/2.jpg>)
这里移除其中一个
```js
group.remove(mesh1)
// scene.remove(pointLightHelper); 移除环境光
```
![](</docs-assets/ThreeJS/img/Three08Img/3.jpg>)

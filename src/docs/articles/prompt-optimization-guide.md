...
![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-6.png>)

### 第二步：点击优化按钮
点击"优化提示词"按钮，打开优化模态框。

![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-1.png>)

### 第三步：选择优化模式
根据您的需求选择合适的优化模式：
![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-7.png>)
### 第四步：查看优化结果
系统会显示优化后的提示词和相关建议。
![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-5.png>)
### 第五步：应用优化
点击"应用优化"将结果应用到输入框中。
![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-8.png>)
效果：
![alt text](</docs-assets/AI/assets/prompt-optimization-guide/image-9.png>)
##  四种优化模式详解

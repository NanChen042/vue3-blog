...
注册及登录展示：
![alt text](</docs-assets/Vue/assets/前端文档/image-5.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-6.png>)

添加好友：
![alt text](</docs-assets/Vue/assets/前端文档/image-7.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-8.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-12.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-9.png>)
效果展示：
![alt text](</docs-assets/Vue/assets/前端文档/image-1.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-10.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-11.png>)
角色展示
![alt text](</docs-assets/Vue/assets/前端文档/image-2.png>)

![alt text](</docs-assets/Vue/assets/前端文档/image-4.png>)
![alt text](</docs-assets/Vue/assets/前端文档/image-3.png>)
---

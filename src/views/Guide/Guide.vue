<template>
  ...
  <div class="box">
    ...
    <vuetyped v-if="isDataLoaded" :strings="sentences" :fadeOutClass="'fadeOutClass'" :fadeOutDelay="10" :loop="false" :startDelay="10" :typeSpeed="100" :backSpeed="10" :fadeOut="true" :autoInsertCss="true" :backDelay="1500" :showCursor="false" :smart-backspace="true" @onComplete="doSmth()">
      <div class="typing">
      </div>
    </vuetyped>
...
const fetchSentence = async () => {
  try {
    ...
    // 设置句子数组
    sentences.value = ["开篇......", response.data.hitokoto];
